...
public class TestBinSearchTree {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (node != null) { testPassed = false; System.out.print("A"); }
			node = tree.getWord("tree");
			if (node == null) { testPassed = false; System.out.print("B"); }
			else {
				...
				while (iter.hasNext()) {
					...
					pos = f.getPositions();
					++j;
					if (pos.size() != 1) { testPassed = false; System.out.print("C"); }
				}
				if (j != 10) {testPassed = false; System.out.print("D"); }
			}
		} catch (Exception e) {
			testPassed = false; System.out.print("E");
		}
